...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("t31.txt");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));


  AsciiTraceHelper asciiTraceHelper1;
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper1.CreateFileStream ("t32.txt");
  ...
  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper2.CreateFileStream ("t33.txt");
  ns3TcpSocket2->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream2));


  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("t31.pcap", std::ios::out, PcapHelper::DLT_PPP);
  d.Get (1)->TraceConnectWithoutContext ("PhyRxDrop", MakeBoundCallback (&RxDrop, file));
  
  PcapHelper pcapHelper1;
  Ptr<PcapFileWrapper> file1 = pcapHelper1.CreateFile ("t32.pcap", std::ios::out, PcapHelper::DLT_PPP);
