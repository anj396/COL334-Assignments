...
main (int argc, char *argv[])
{
  ...
  string specificNode = "/NodeList/" + nodeId.str () + "/$ns3::TcpL4Protocol/SocketType";
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("t21.txt");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));


  AsciiTraceHelper asciiTraceHelper1;
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper1.CreateFileStream ("t22.txt");
  ...
  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper2.CreateFileStream ("t23.txt");
  ns3TcpSocket2->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream2));


  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("t21.pcap", std::ios::out, PcapHelper::DLT_PPP);
  d.Get (1)->TraceConnectWithoutContext ("PhyRxDrop", MakeBoundCallback (&RxDrop, file));
  
  PcapHelper pcapHelper1;
  Ptr<PcapFileWrapper> file1 = pcapHelper1.CreateFile ("t22.pcap", std::ios::out, PcapHelper::DLT_PPP);
